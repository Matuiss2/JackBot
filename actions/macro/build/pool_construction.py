...
class PoolConstruction:
    ...
    async def should_handle(self):
        ...
        return self.main.can_build_unique(UnitTypeId.SPAWNINGPOOL, self.main.pools) and (
            self.main.base_amount >= 2 or self.main.close_enemy_production or self.main.time > 145
        )

    async def handle(self):
        """Places the pool"""
        await self.main.place_building(UnitTypeId.SPAWNINGPOOL)
