...
class Drone:
    ...
    async def should_handle(self):
        ...
        self.drones = self.main.drones
        return self.drones and self.main.iteration % 2000 == 75 and not self.main.close_enemy_production

    async def handle(self):
        """It sends 2 drones to scout the map, for rushes or proxies"""
        scout = self.drones.closest_to(self.main.start_location)
        ...
        if not self.rush_scout:
            ...
            self.main.add_action(self.drones.random.move(self.main.enemy_start_locations[0]))
