...
class Overlord:
    ...
    async def should_handle(self):
        ...
        self.overlords = self.main.overlords.ready
    ...
    async def handle(self):
        ...
        if not self.first_ov_scout:
            ...
            self.selected_ov = self.overlords.closest_to(self.main.furthest_townhall_to_center)
            ...
            self.selected_ov = self.overlords.closest_to(self.main.townhalls.first)
