...
class Overlord:
    ...
    async def handle(self, iteration):
        ...
        if not self.first_ov_scout:
            ...
            self.ai.adding(self.ai.overlords.first.move(natural.towards(self.ai._game_info.map_center, 10)))
            ...
            self.ai.adding(second_ov.move(self.ai._game_info.map_center))
        # self.ai.adding(self.ai.overlords.first.move(enemy_natural.towards(enemy_main, -11)))
