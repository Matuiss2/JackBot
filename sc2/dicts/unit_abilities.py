...
UNIT_ABILITIES: Dict[UnitTypeId, Set[AbilityId]] = {
    ...
    UnitTypeId.FACTORYTECHLAB: {AbilityId.RESEARCH_CYCLONELOCKONDAMAGE, AbilityId.RESEARCH_INFERNALPREIGNITER},
    ...
    UnitTypeId.GREATERSPIRE: {AbilityId.RESEARCH_ZERGFLYERARMORLEVEL1, AbilityId.RESEARCH_ZERGFLYERATTACKLEVEL1},
